import { BN, workspace, Program } from "@coral-xyz/anchor";
import { Marginfi } from "../target/types/marginfi";
import { bankKeypairUsdc, groupAdmin, oracles, users } from "./rootHooks";
import { InterestRateConfigRawWithOrigination, BankConfigOptRaw, ASSET_TAG_SOL, defaultBankConfigOptRaw, FREEZE_SETTINGS, CLOSE_ENABLED_FLAG } from "./utils/types"; 
import { bigNumberToWrappedI80F48 } from "@mrgnlabs/mrgn-common";
import { configureBank, configureBankOracle } from "./utils/group-instructions";
import { Transaction } from "@solana/web3.js";
import { assertBNEqual, assertI80F48Approx, assertKeysEqual, expectFailedTxWithError, expectFailedTxWithMessage } from "./utils/genericTests";
