use crate::{
    ...
    utils::{calculate_pre_fee_spl_deposit_amount, maybe_take_bank_mint, validate_asset_tags},
};
...
/// 1. Accrue interest
/// 2. Create the user's bank account for the asset deposited if it doesn't exist yet
...
pub fn lending_account_deposit<'info>(
    ...
    let clock = Clock::get()?;
    let maybe_bank_mint = maybe_take_bank_mint(
